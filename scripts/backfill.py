...
SHEET_MAP = {
    ...
    "Distributor":                     ("10up/distributor",                                "Distributor",                            "distributor"),
    "Eight Day Week":                  ("10up/eight-day-week",                             "Eight Day Week",                         "eight-day-week-print-send"),
    "ElasticPress":                    ("10up/ElasticPress",                               "ElasticPress",                           "elasticpress"),
    "ElasticPress Labs":               ("10up/ElasticPressLabs",                           "ElasticPress Labs",                      None),
    "Embed Figma Block":               ("10up/embed-block-figma",                          "Figma Block",                            None),
    ...
    "Winamp Block":                    ("10up/retro-winamp-block",                         "Winamp Block",                           None),
